...
const LandingPage = () => {
  const images = [girl1, girl3, girl4, girl5, BrickLane];
      ...
      <section className="py-24 bg-white" id="services">
        <div className="container mx-auto px-4">
          ...
          >
            {[
              {
                icon: <CircleDollarSign className="h-10 w-10 text-blue-500" />,
              ...
              {
                icon: <UserRoundCheck className="h-10 w-10 text-purple-500" />,
              ...
              {
                icon: <Hotel className="h-10 w-10 text-pink-500" />,
